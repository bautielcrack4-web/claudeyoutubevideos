// dense_prep_vlnljrhb5gbv.mjs — toma public/broll/dense_vlnljrhb5gbv.json ({at,query}) →
// resuelve cada 'at' al ms del caption, afina a ~2.3s, asigna nombres POR-SLUG (anti-colisión) y escribe:
//   public/broll/dense_thinned_vlnljrhb5gbv.json
//   public/broll/shots_dense_vlnljrhb5gbv.json  (para fetchstock)
//   src/_fed6/VideoEdit/federer_vlnljrhb5gbv_broll.ts  (FEDZ_BROLL, track contiguo)
import fs from "fs";
...
const VEND = (CW[CW.length - 1]?.s || 1370) + 2;
