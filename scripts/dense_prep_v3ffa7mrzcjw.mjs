// dense_prep_v3ffa7mrzcjw.mjs — toma public/broll/dense_v3ffa7mrzcjw.json ({at,query}) →
// resuelve cada 'at' al ms del caption, afina a ~2.3s, asigna dNNN y escribe:
//   public/broll/dense_thinned_v3ffa7mrzcjw.json
//   public/broll/shots_dense_v3ffa7mrzcjw.json  (para fetchstock)
//   src/_fed6/VideoEdit/federer_v3ffa7mrzcjw_broll.ts  (FEDZ_BROLL, track contiguo)
import fs from "fs";
