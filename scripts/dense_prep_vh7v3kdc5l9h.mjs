// dense_prep_vh7v3kdc5l9h.mjs — toma public/broll/dense_vh7v3kdc5l9h.json ({at,query}) →
// resuelve cada 'at' al ms del caption, afina a ~2.3s, asigna nombres POR-SLUG (anti-colisión) y escribe:
//   public/broll/dense_thinned_vh7v3kdc5l9h.json
//   public/broll/shots_dense_vh7v3kdc5l9h.json  (para fetchstock)
//   src/_fed6/VideoEdit/federer_vh7v3kdc5l9h_broll.ts  (FEDZ_BROLL, track contiguo)
import fs from "fs";
