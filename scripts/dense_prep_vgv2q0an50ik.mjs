// dense_prep_vgv2q0an50ik.mjs — toma public/broll/dense_vgv2q0an50ik.json ({at,query}) →
// resuelve cada 'at' al ms del caption, afina a ~2.3s, asigna nombres POR-SLUG (anti-colisión) y escribe:
//   public/broll/dense_thinned_vgv2q0an50ik.json
//   public/broll/shots_dense_vgv2q0an50ik.json  (para fetchstock)
//   src/_fed6/VideoEdit/federer_vgv2q0an50ik_broll.ts  (FEDZ_BROLL, track contiguo)
import fs from "fs";
