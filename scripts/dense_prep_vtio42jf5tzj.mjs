// dense_prep_vtio42jf5tzj.mjs — toma public/broll/dense_vtio42jf5tzj.json ({at,query}) →
// resuelve cada 'at' al ms del caption, afina a ~2.3s, asigna nombres POR-SLUG (anti-colisión) y escribe:
//   public/broll/dense_thinned_vtio42jf5tzj.json
//   public/broll/shots_dense_vtio42jf5tzj.json  (para fetchstock)
//   src/_fed6/VideoEdit/federer_vtio42jf5tzj_broll.ts  (FEDZ_BROLL, track contiguo)
import fs from "fs";
