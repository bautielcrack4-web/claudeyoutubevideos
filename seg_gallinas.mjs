import fs from "fs";
const caps = JSON.parse(fs.readFileSync("public/captions_gallinas.json", "utf8"));
...
fs.writeFileSync("transcript_gallinas_segments.txt", lines.join("\n"));
fs.writeFileSync("public/segments_gallinas.json", JSON.stringify(segs, null, 2));
