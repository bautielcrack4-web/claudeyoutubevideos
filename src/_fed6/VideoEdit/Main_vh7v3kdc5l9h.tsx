...
import { TALKSZ } from "./federer_vh7v3kdc5l9h_hooks";
...
export const TOTAL_FRAMES_VH7 = Math.round(VIDEO_END * 30);
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: BG }}>
      ...
      <Sequence from={sec(hookStart)} durationInFrames={sec(hookDur)} layout="none">
        <AvatarScrimText durationInFrames={sec(hookDur)} setup="Te despertás con la BOCA SECA después de los 60…" impact="NO ES LA EDAD, ES UN AVISO" accentColor="#12B3AE" font={F_INTER} fontSize={120} />
      </Sequence>
