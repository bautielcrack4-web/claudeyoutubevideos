// FocusCards_vlnljrhb5gbv.tsx — componente PROPIO del slug (aislado, no toca archivos compartidos).
...
export const FocusCardsVlnl: React.FC<{ durationInFrames: number; items: Item[]; title?: string }> = ({ durationInFrames, items, title }) => {
