...
import { TALKSZ } from "./federer_vtio42jf5tzj_hooks";
...
export const TOTAL_FRAMES_VTIO = Math.round(VIDEO_END * 30);
...
FEDZ_BEATS.filter((b: any) => /^(hook|story|principio|porque60|reveal|comparacion|comerlo|acompanan|mitos|honesto|error|recap|cierre)$/.test(b.key) && (b.id.endsWith("_0")))
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: BG }}>
      ...
      <Sequence from={sec(hookStart)} durationInFrames={sec(hookDur)} layout="none">
        <AvatarScrimText durationInFrames={sec(hookDur)} setup="Tu creatinina sube en silencio después de los 60…" impact="LA VERDURA #1 QUE CUIDA TUS RIÑONES" accentColor="#12B3AE" font={F_INTER} fontSize={110} />
      </Sequence>
