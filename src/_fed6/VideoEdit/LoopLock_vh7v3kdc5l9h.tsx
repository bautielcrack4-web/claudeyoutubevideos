// LoopLock_vh7v3kdc5l9h.tsx — componente PROPIO del slug (aislado). Tarjeta CANDADO para plantar el
// loop grande del hook: "la quinta causa… te la digo al final". Fondo oscuro, candado teal, texto
// borroso/censurado que sugiere sin spoilear. Feedback creador (2026-07-21, hook irresistible).
...
export const LoopLockVh7: React.FC<{ durationInFrames: number; title?: string; sub?: string }> = ({ title = "La quinta causa", sub = "la que menos perdona — te la digo al final" }) => {
