...
import { CUES, OVERLAYS } from "./cues_construcciones.gen";

// ── 7 CONSTRUCCIONES ANTIGUAS QUE LA CIENCIA NO PUEDE EXPLICAR — Crónicas Perdidas · FACELESS ──
// FLAGSHIP (nivel barcos): ~385 clips densos (corte ~3.6s) + KIT de componentes
// (rule/stat/timeline/scalecolossus + overlays doclabel/datestamp/countrail), todo anclado al
// ms real de la narración Trevor (construcciones_timing.json). SIN filtros de color (grano 0, viñeta 0).
...
export const TOTAL_FRAMES_CONS = Math.round(SECONDS * 30);
...
export const MainConstrucciones: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: COLORS.bg0 }}>
      ...
      <Audio src={staticFile("construcciones_music.mp3")} loop volume={0.07} />
    </AbsoluteFill>
  );
};
