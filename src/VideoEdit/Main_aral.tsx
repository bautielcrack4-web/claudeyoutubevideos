...
import { CUES, OVERLAYS } from "./cues_aral.gen";

// ── LOS MAR DE ARAL — del desastre al regreso — documental FACELESS ──
// Voz clonada (public/aral.wav) + flujo denso de clips/imágenes reales + componentes.
...
export const TOTAL_FRAMES_AR = Math.round((END + 1.5) * 30);
...
export const MainAral: React.FC = () => {
  return (
