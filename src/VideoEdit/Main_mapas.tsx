...
import { CUES, OVERLAYS } from "./cues_mapas.gen";
import SFX from "./sfx_mapas.json";

// ── 7 MAPAS ANTIGUOS QUE NO DEBERÍAN EXISTIR — Crónicas Perdidas · FACELESS ──
const DIS = 10;
...
export const TOTAL_FRAMES_MAP = Math.round(SECONDS * 30);

export const MainMapas: React.FC = () => {
  return (
    <AbsoluteFill style={{ backgroundColor: COLORS.bg0 }}>
      ...
      <Audio src={staticFile("mapas.wav")} />
      <Audio src={staticFile("mapas_music.mp3")} loop volume={0.07} />
