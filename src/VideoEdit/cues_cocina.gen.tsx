...
export const CUES: Cue[] = [
  ...
  { key: "intro_1", start: 7.65, dur: 5.12, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_mercado_viejo.mp4" hue="red" kicker="Cómo era la vida antes" /> },
  { key: "intro_2", start: 12.77, dur: 3.37, kind: "float", el: (d) => <FloatingInsert durationInFrames={d} src="broll/co_abuela_cocina.mp4" side="right" hue="blue" /> },
  ...
  { key: "s01_huerta_1", start: 71.88, dur: 9.09, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_huerta.mp4" hue="blue" /> },
  { key: "s01_huerta_2", start: 80.97, dur: 15.47, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_tomate_planta.mp4" hue="amber" kicker="Tibio del sol" /> },
  ...
  { key: "s02_gallinero_0", start: 126.46, dur: 6.79, kind: "rule", el: (d) => <RuleNumberScene durationInFrames={d} number="02" title="El gallinero" hue="blue" /> },
  { key: "s02_gallinero_1", start: 133.25, dur: 9.7, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_gallinero.mp4" hue="amber" /> },
  { key: "s02_gallinero_2", start: 142.95, dur: 16.49, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_huevos_juntar.mp4" hue="red" /> },
  { key: "s02_gallinero_3", start: 159.44, dur: 9.7, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_huevo_yema.mp4" hue="blue" kicker="Yema naranja, fuerte" /> },
  { key: "s02_gallinero_4", start: 169.14, dur: 7.11, kind: "float", el: (d) => <FloatingInsert durationInFrames={d} src="img/co_ai_huerta_gallinas.png" side="left" hue="amber" /> },
  { key: "s02_gallinero_5", start: 176.25, dur: 9.86, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="broll/co_huevo_yema.mp4" words={parseQuote("Comíamos sabiendo el *costo* de las cosas.")} hue="red" /> },
  ...
  { key: "s04_reparto_3", start: 284.9, dur: 7.09, kind: "float", el: (d) => <FloatingInsert durationInFrames={d} src="broll/co_pan_reparto.mp4" side="left" hue="red" /> },
  { key: "s04_reparto_4", start: 291.99, dur: 9.68, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_verduleria.mp4" hue="blue" /> },
  { key: "s04_reparto_5", start: 301.67, dur: 6.77, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="broll/co_leche_botella.mp4" words={parseQuote("La comida llegaba de la mano de un vecino, no de un camión *sin cara*.")} hue="amber" /> },
  ...
  { key: "s05_fiambrera_4", start: 351.86, dur: 8.76, kind: "bars", el: (d) => <BarCompare durationInFrames={d} bars={[{"label":"Sin freezer","value":1},{"label":"Hoy","value":9}]} title="Comida que se desperdicia" hue="amber" /> },
  { key: "s05_fiambrera_5", start: 360.62, dur: 7.35, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="broll/co_fiambrera.mp4" words={parseQuote("Vivíamos con lo justo, y no se tiraba *nada*.")} hue="red" /> },
  ...
  { key: "s06_conservar_3", start: 400.67, dur: 9.61, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_escabeche.jpg" hue="amber" kicker="En vinagre, en escabeche" /> },
  { key: "s06_conservar_4", start: 410.28, dur: 7.06, kind: "float", el: (d) => <FloatingInsert durationInFrames={d} src="img/co_ai_despensa_frascos.png" side="left" hue="red" /> },
  ...
  { key: "s07_pan_0", start: 431.76, dur: 6.21, kind: "rule", el: (d) => <RuleNumberScene durationInFrames={d} number="07" title="El pan amasado en casa" hue="red" /> },
  { key: "s07_pan_1", start: 437.97, dur: 15.07, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_pan_amasar.mp4" hue="blue" kicker="Harina, agua, sal y las manos" /> },
  { key: "s07_pan_2", start: 453.04, dur: 8.87, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_pan_horno.mp4" hue="amber" /> },
  { key: "s07_pan_3", start: 461.91, dur: 8.57, kind: "process", el: (d) => <ProcessSteps durationInFrames={d} steps={[{"title":"Mezclar","image":"broll/co_pan_amasar.mp4"},{"title":"Levar","image":"broll/co_despensa.mp4"},{"title":"Al horno","image":"broll/co_pan_horno.mp4"},{"title":"El duro → budín","image":"broll/co_sobras.mp4"}]} title="Pan amasado en casa" hue="red" /> },
  { key: "s07_pan_4", start: 470.48, dur: 21.53, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="broll/co_pan_amasar.mp4" words={parseQuote("El pan de verdad dura un día. Con el duro hacíamos el *budín*.")} hue="blue" /> },
  { key: "s08_animal_0", start: 492.01, dur: 9.87, kind: "rule", el: (d) => <RuleNumberScene durationInFrames={d} number="08" title="El animal, de la nariz a la cola" hue="blue" /> },
  { key: "s08_animal_1", start: 501.88, dur: 23.96, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_caldo.mp4" hue="amber" kicker="Los huesos, caldo" /> },
  { key: "s08_animal_2", start: 525.84, dur: 10.33, kind: "float", el: (d) => <FloatingInsert durationInFrames={d} src="broll/co_embutidos.mp4" side="right" hue="red" /> },
  { key: "s08_animal_3", start: 536.17, dur: 10.34, kind: "splitlist", el: (d) => <SplitList durationInFrames={d} title="No se tiraba nada del animal" items={["Huesos para el caldo","Grasa para cocinar","Achuras, morcilla"]} accent={A} /> },
  { key: "s08_animal_4", start: 546.51, dur: 11.31, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="broll/co_caldo.mp4" words={parseQuote("Comer se volvió algo sin *conciencia*.")} hue="amber" /> },
  ...
  { key: "s10_notirar_0", start: 627.72, dur: 9.03, kind: "rule", el: (d) => <RuleNumberScene durationInFrames={d} number="10" title="No se tiraba nada" hue="red" /> },
  { key: "s10_notirar_1", start: 636.75, dur: 12.9, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_sobras.mp4" hue="blue" /> },
  { key: "s10_notirar_2", start: 649.65, dur: 21.93, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_croquetas.mp4" hue="amber" kicker="Las sobras, croquetas" /> },
  { key: "s10_notirar_3", start: 671.58, dur: 10.32, kind: "checklist", el: (d) => <Checklist durationInFrames={d} title="El arte de transformar" items={[{"text":"Pan duro → budín","state":"done"},{"text":"Puchero → croquetas","state":"done"},{"text":"Huesos → caldo","state":"done"},{"text":"Fruta pasada → dulce","state":"done"}]} hue="red" /> },
  { key: "s10_notirar_4", start: 681.9, dur: 48.23, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="broll/co_sobras.mp4" words={parseQuote("Nosotros, que teníamos tan poco, valorábamos cada *miga*.")} hue="blue" /> },
  { key: "extras_0", start: 730.13, dur: 32.93, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_cocina_lena.mp4" hue="blue" kicker="El centro de la casa" /> },
  { key: "extras_1", start: 763.06, dur: 14.21, kind: "float", el: (d) => <FloatingInsert durationInFrames={d} src="broll/co_olla_fuego.mp4" side="left" hue="amber" /> },
  { key: "extras_2", start: 777.27, dur: 19.37, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_leche_tambo.mp4" hue="red" kicker="La leche del tambo" /> },
  { key: "extras_3", start: 796.64, dur: 19.37, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_nata.mp4" hue="blue" /> },
  { key: "extras_4", start: 816.01, dur: 16.14, kind: "bars", el: (d) => <BarCompare durationInFrames={d} bars={[{"label":"Antes: sano = barato","value":10},{"label":"Hoy: sano = caro","value":3}]} title="Lo barato y lo sano" hue="amber" /> },
  { key: "extras_5", start: 832.15, dur: 5.8, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="broll/co_cocina_lena.mp4" words={parseQuote("El pobre comía sano porque lo sano era lo *barato*.")} hue="red" /> },
  { key: "cierre_0", start: 837.95, dur: 15.18, kind: "headline", el: (d) => <KineticHeadline durationInFrames={d} tokens={[{"t":"Todo"},{"t":"es"},{"t":"la"},{"t":"misma"},{"t":"historia","hl":true}]} eyebrow="¿Te das cuenta?" hue="amber" bg="image" image="broll/co_huerta.mp4" /> },
  { key: "cierre_1", start: 853.13, dur: 22.76, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_supermercado.mp4" hue="red" kicker="Lleno de todo y tan vacío" /> },
  { key: "cierre_2", start: 875.89, dur: 36.43, kind: "journey", el: (d) => <JourneyCanvas durationInFrames={d} eyebrow="Rescatá lo bueno" title="Con tus propias manos" waypoints={[{"x":0,"y":0,"z":0,"image":"broll/co_tomate_planta.mp4","label":"Plantá un tomate","num":"1","dwell":2.6,"travel":1.6},{"x":1.2,"y":-0.4,"z":0.3,"image":"broll/co_pan_amasar.mp4","label":"Amasá un pan","num":"2","dwell":2.6,"travel":1.6},{"x":2.4,"y":0.3,"z":-0.2,"image":"broll/co_despensa.mp4","label":"Hacé un dulce","num":"3","dwell":2.6,"travel":1.6},{"x":3.6,"y":-0.2,"z":0.2,"image":"broll/co_abuela_cocina.mp4","label":"Cociná para alguien","num":"4","dwell":3,"travel":1.4}]} /> },
  { key: "cierre_3", start: 912.32, dur: 18.21, kind: "aged", el: (d) => <AgedDoc durationInFrames={d} heading="Andá al principio de la cadena" lines={[{"text":"Las meriendas, los postres, los domingos."},{"text":"Es toda la misma historia."}]} hue="amber" /> },
  { key: "cierre_4", start: 930.53, dur: 38.7, kind: "raw", el: (d) => <RawShot durationInFrames={d} src="broll/co_abuela_cocina.mp4" hue="red" /> },
  { key: "cierre_5", start: 969.23, dur: 3.77, kind: "quote", el: (d) => <KineticQuote durationInFrames={d} image="broll/co_huerta.mp4" words={parseQuote("Comé algo hecho en casa, por favor. Hacelo *por mí*.")} hue="blue" /> },
];
